            ...
            <template x-if="gameState === 'intro'">
                <div class="text-center py-6">
                    ...
                    <div class="flex justify-center mb-8">
                        <img src="{{ secure_asset('images/characters/turtle.png') }}" alt="Teacher Turtle" class="h-40">
                    </div>
                ...
                <div class="text-center py-6">
                    ...
                    <div class="flex justify-center mb-8">
                        ...
                        <template x-if="scorePercentage < 50">
                            <div class="text-center">
                                <img src="{{ secure_asset('images/characters/turtle-thinking.png') }}" alt="Thinking Turtle"
                                    class="h-40 mx-auto">
