    ...
    <div class="bg-white rounded-2xl shadow-xl p-6 max-w-md w-full" @click.away="step === 0 ? skipTour() : null">
        ...
        <template x-if="step === 0">
            <div class="text-center">
                <img src="{{ secure_asset('images/logo.png') }}" alt="DIGITALINO Logo" class="h-24 mx-auto mb-4">
                ...
                <div class="flex flex-col items-center mb-6">
                    <img src="{{ secure_asset('images/mascot.png') }}" alt="DIGITALINO Mascot" class="h-32 mb-3">
        ...
        <template x-if="step === 1">
            <div>
                ...
                <div class="mb-6">
                    <img src="{{ secure_asset('images/tour/profiles.png') }}" alt="Profile Creation"
        ...
        <template x-if="step === 2">
            <div>
                ...
                <div class="mb-6">
                    <img src="{{ secure_asset('images/tour/games.png') }}" alt="Game Hub" class="w-full h-40 object-cover rounded-lg mb-3">
                    <p class="text-gray-600">
        ...
        <template x-if="step === 3">
            <div>
                ...
                <div class="mb-6">
                    <img src="{{ secure_asset('images/tour/progress.png') }}" alt="Progress Tracking"
                        class="w-full h-40 object-cover rounded-lg mb-3">
                    <p class="text-gray-600">
        ...
        <template x-if="step === 4">
            <div>
                ...
                <div class="mb-6">
                    <img src="{{ secure_asset('images/tour/settings.png') }}" alt="Settings"
                        class="w-full h-40 object-cover rounded-lg mb-3">
                    <p class="text-gray-600">
        ...
        <template x-if="step === 5">
            <div>
                ...
                <div class="flex flex-col items-center mb-6">
                    <img src="{{ secure_asset('images/characters/panda-happy.png') }}" alt="Happy Panda" class="h-32 mb-3">
